...
const Add = () => {
  ...
  return (
    <div className="h-full w-full bg-gray-300 overflow-y-auto px-2 sm:px-4 md:px-6 py-4">
      <form
        onSubmit={handleSubmit}
        className="max-w-5xl w-full mx-auto bg-[#EFF1DB] shadow-md rounded-lg p-4 sm:p-6 md:p-8"
      >
        <div className="mb-3 text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">Add a New Room</h1>
